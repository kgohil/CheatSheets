...
Source: [Nikolay Grozev's blog](https://nikgrozev.com/2016/05/22/shell-cheatsheet-part-1-common-bash-scripting-tmux/)
...
The code of the script should handle start, stop, restart, etc. The following example (taken from here) 
